...
namespace Assignment
{
    public class Assignment : MonoBehaviour
    {
        ...
        public void AS02_CountNumber()
        {
            ...
            int[] numbers = new int[numberCounts.Keys.Count];
            int[] counts = new int[numberCounts.Values.Count];

            numberCounts.Keys.CopyTo(numbers, 0);
            numberCounts.Values.CopyTo(counts, 0);

            for (int i = 0; i < numbers.Length; i++)
            {
                Debug.Log($"number: {numbers[i]} count: {counts[i]}");
            }
        }
        ...
        public void AS08_TopFrequentNumber()
        {
            ...
            foreach (int number in numbers)
            {
                int currentCount = frequency[number];
        ...
        public void AS10_GameEventQueue()
        {
            ...
            {
                Debug.Log("The event queue is empty.");
                return;
            }
